...
CREATE TABLE mart.fact_kauf (
  ...
  , CONSTRAINT fk_fact_kauf_kfz FOREIGN KEY (dim_kfz_id) REFERENCES mart.dim_kfz(dim_kfz_id)
--  , CONSTRAINT fk_fact_kauf_date_kauf FOREIGN KEY (kauf_kalender_datum) REFERENCES mart.dim_datum(kalender_datum)
