INSERT INTO
      staging.hersteller (hersteller_code, hersteller_name, quelle)
values
      ...
      (
            'SNT',
            'Sachsenring Automobilwerke Zwickau GmbH',
            'Fahrzeug DB'
      );

INSERT INTO
      staging.land (land_id, land, quelle)
values
...
INSERT INTO
      staging.ort (ort_id, ort, land_id, quelle)
values
...
VALUES
      ...
      (
            ...
            'K004',
            'GHI789',
            to_date('2019-09-18', 'YYYY-MM-DD'),
            to_date('2019-09-25', 'YYYY-MM-DD'),
            26000,
            4,
            'OLTP: Buchungssystem'
      ),
